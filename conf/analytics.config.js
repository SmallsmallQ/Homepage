...
module.exports = {
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-WB7QDKJ39B', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || '这里粘贴从GoogleSearchConsole获取的正确验证码', // 从 Google Search Console 获取 HTML 标签验证码
